...
var steps = [
    { popover: { title: 'Dashboard', description: 'Hetosa dashboard section' } },
...
setTimeout(() => {
    ...
    if ($('[data-id="dashboardNav"]').length) {
        steps.push({ element: '[data-id="dashboardNav"]', popover: { title: 'App', description: 'Hetosa Hr Apps. eg Dashboard' } });
    }
}, 1000);
driverObj = driver(
